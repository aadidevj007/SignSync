      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-block mb-4">
            <div className="w-16 h-16 mx-auto bg-white bg-opacity-20 rounded-full flex items-center justify-center backdrop-blur-sm">
          ...
          <p className="text-blue-100">
            {isLogin ? 'Sign in to continue to SignSync Meet' : 'Join SignSync Meet today'}
          </p>
        </div>
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-8 border border-white border-opacity-20">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 bg-white bg-opacity-10 hover:bg-opacity-20 text-white font-semibold rounded-lg border border-white border-opacity-20 transition-all duration-300 flex items-center justify-center space-x-2 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed"
          >
